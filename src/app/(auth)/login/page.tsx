    ...
    <div className="min-h-screen flex items-center justify-center bg-zen-bg py-12 px-4">
      <div className="bg-white p-10 rounded-2xl shadow-sm border border-zen-border w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-zen-ink/60 text-sm tracking-wide">เข้าสู่ระบบ</p>
        </div>
        ...
        <form action={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-sm font-medium text-zen-ink/80 mb-2">Email หรือ ชื่อผู้ใช้</label>
            <input 
              type="text" 
              name="identifier" 
              required 
        ...
        <div className="mt-8 text-center text-sm text-zen-ink/60">
          ยังไม่มีบัญชี?{' '}
          <Link href="/register" className="text-zen-accent hover:underline font-medium">
            สมัครสมาชิก
          </Link>
        </div>
      </div>
